...
<head>
  ...
  <link href="https://fonts.googleapis.com/css2?family=Josefin+Sans:wght@100;200;300;500;600;700&display=swap"
    rel="stylesheet">
  ...
  <div id="demo" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img
          src="https://static.vecteezy.com/system/resources/thumbnails/004/585/326/small/banking-building-business-finance-management-low-poly-wireframe-illustration-isolated-background-free-vector.jpg"
      ...
      <div class="carousel-item">
        <img src="https://i.pinimg.com/736x/15/3a/45/153a4535df6cf2d2b106a558b750c486.jpg" alt="Chicago" width="1100"
          height="500">
        <div class="carousel-caption">
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-lg-16 col-md-6 col-12">
          <img
            src="https://www.bankrate.com/2021/03/03090936/Top-15-largest-banks-in-the-US.jpg?auto=webp&optimize=high&crop=16:9"
            class="img-fluid">
        </div>
        <div class="col-lg-16 col-md-6 col-12">
          <h2>Delighting customers with our excellent service and comprehensive suite of best-in-class financial
            solutions</h2>
          <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Rerum, consequatur? Doloribus, ab? Animi
            praesentium illum aperiam ullam, officiis deserunt similique amet sit velit laboriosam illo explicabo
            nostrum distinctio dolorem sint! Lorem ipsum dolor sit amet consectetur adipisicing elit. Accusantium
            numquam, quidem reprehenderit rem, nostrum quo libero ipsum dolorem quod sunt voluptate a ratione quas
            voluptates veniam atque dolor praesentium quam! Lorem ipsum dolor sit amet consectetur adipisicing elit.
            Nobis quaerat illo saepe fugit nisi praesentium delectus, dignissimos sed explicabo recusandae repudiandae
            sequi neque expedita nesciunt perspiciatis cum voluptatum velit. Perspiciatis.</p>
          <a href="#">Know More</a>
        </div>
      </div>
    </div>
  ...
  <section class="my-5">
    <div class="py-5">
      ...
      <p1>This website is the
        ...
        without explicit permission, provided that the content is accompanied by an acknowledgement that Apna Bank
