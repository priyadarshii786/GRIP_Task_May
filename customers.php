...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  <div class="container-fluid">
    <a class="navbar-brand" href="#">Foundation Bank </a>
...
<body style="background-image : url(https://media.istockphoto.com/id/1150199713/photo/finger-of-businessman-touching-and-check-mark-icon-face-emoticon-smile-on-dark-background.jpg?s=612x612&w=0&k=20&c=7tUsPBeBoE33GW_8PYQr3_xMV9UYWcYI6zYZgeWkeXQ=)">
<?php
    include 'config.php';
...
<div class="container">
        ...
        <br>
         ...
         <footer class="text-center mt-5 py-2 ">
            <p style="color:white">2023 <b>Tathagat Priyadarshi</b> <br> Foundation Bank</p>
        </footer>
